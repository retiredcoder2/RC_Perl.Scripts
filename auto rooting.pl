#!/usr/bin/perl
#
#		==>> Mr.akinova's Auto Rooting <<==
#
#
#	---------------------------------------------------------------------------------------------------------------------------
#	Script : Perl
#	By : Mr.akinova's
#	From : Cyber Quake Inc.
#	Contact : Mr.akinova's@Gmail.Com , cyberquakeinc@gmail.Com , futurehackerz@gmail.Com
#	Version : 2.0
#	For Black Hat & Real Hackers
#	---------------------------------------------------------------------------------------------------------------------------	
#	Spc TNX : Pentesters , Ashiyane , PHC , Cyberquake , ITSEC , MGG , Sun-Army , MAVI1 , .... TEAMS
#	---------------------------------------------------------------------------------------------------------------------------
...
print "\t\t\tMr.akinova's Auto Rooting\n";
print "\t\t\tVersion : 2.0\n";
print "\n";
print "\n\n";
print "\t\t------------------------------------\n";
print "\t\t\tCoded By Mr.akinova's\n";
print "\t\t------------------------------------\n";
print "\t\t For See Commands type [help] :D\n";
print "\n";
command:;
print 'akinova@Localr00t#:';
$command = <STDIN>;
